...
| Multi-Session XAUUSDc Telemetry | ⏳ PARTIAL (ASIAN + LONDON collected) | 5834 read-only samples — ASIAN 2240 (00:38–01:46 UTC, median 36, max 36) + LONDON 3594 (09:56–10:56 UTC, median 34, max 36); spread 34–36 pts, 0% > 45 in all windows; short-window protocol (30–60 min) active; raw `docs/validation/runtime/multi-session/xauusdc-spread-timeseries.jsonl` + report `xauusdc-multi-session-report.md`; overlap/NY/off-hours pending; production UNLOCKED | docs-only |
