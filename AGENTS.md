...
| 2026-08-18 00:00 +07 | Multi-Session XAUUSDc Telemetry — NEW_YORK window | COMPLETE | NEW_YORK n=3597 read-only samples (2026-08-17 16:00:00–17:00:00 UTC, 3600 s @ 1 s, manual delayed-start background process — prior cron one-shot 21:00 WIB never fired, sleep-until-23:00-WIB + 3600 s collection); spread min 34 / median 34 / mean 34.28 / P75 34 / P90 36 / P95 36 / P99 36 / max 36; 0% > 36; distribution: 34 pts (85.5%), 35 pts (0.5%), 36 pts (14.0%); validation 0 malformed, 0 missing fields, 0 duplicate timestamps; total now 11397 (ASIAN 2240 + LONDON 3594 + OVERLAP 1966 + NEW_YORK 3597); zero execution | KEY FINDING: NEW_YORK tightest session (median 34, mean 34.28, 85.5% at 34 pts) — spread widening 45–50 ISOLATED to OVERLAP only. ASIAN/LONDON/NEW_YORK all 34–36, zero > 36. SL 50 SAFE for ASIAN+LONDON+NEW_YORK (14pt margin, 38.9%). OVERLAP is sole risk window (0pt SL margin, 19% rejection at max_spread 45). max_spread 45 + SL 50 lock CONDITIONAL: viable IF operating window excludes LONDON_NY_OVERLAP (12:00–16:00 UTC / 19:00–23:00 WIB). Production RiskConfig UNLOCKED. OFF_HOURS optional. Owner decision: include or exclude OVERLAP from operating window. |
